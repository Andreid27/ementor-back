...
begin
	...
	insert into users (id, email, first_name, last_name, creation, password,phone ,user_role, active, disabled,hasProfile)
		...
		(gen_random_uuid(), 'angie@dinca.co', 'Enache', 'Angie-Maria', now(), '$2a$10$YhVfNEeqR7ZQTs0pJTR/AeYoCDeS8bUgcHBEwTaQxJDxWOu6lsvmy','+40720464201','PROFESSOR', true, false, true),
