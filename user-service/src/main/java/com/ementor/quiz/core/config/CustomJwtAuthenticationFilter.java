...
package com.ementor.quiz.core.config;

import com.ementor.quiz.core.entity.CustomUserDetailsService;
import com.ementor.quiz.core.service.CustomAuthenticationProvider;
import com.ementor.quiz.core.service.JwtService;
	...
	protected void doFilterInternal(@NonNull HttpServletRequest request,
		...
		if (userEmail != null && SecurityContextHolder.getContext()
			...
			if (jwtService.isTokenValid(jwt, user)
					&& Boolean.TRUE.equals(customAuthenticationProvider.checkIfAllMatch(user, userEmail))) {
